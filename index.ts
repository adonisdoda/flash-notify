...
const showFlash = ({ type, title, desc, customColors = null }: { type: 'NEUTRAL' | 'DANGER' | 'WARNING', title: string, desc: string, customColors: any }) => EventEmitter.emit('SHOW_FLASH', { type, title, desc, customColors })
